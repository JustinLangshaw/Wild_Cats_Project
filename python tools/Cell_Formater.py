                ...
                try: 
                    ...
                    #Two Digits found
                        ...
                        if any(re.findall(r'\-|to', example)):
                            print(x + 1, " | ", digits,
                                  " Two Numbers Found with: -, to. Might be range. Averaging and appending")
                            ...
                            if any(re.findall(r'kitten|cub', example)):
                                print(x + 1, " | ", digits,
                                      " Two Numbers Found with: +, and, includes, including, kitten, kittens. Might be range. Averaging and appending")
                                average = int(digits[0]) + int(digits[1])
                                totalAppends += 1
                                totalCorrections += 1
                                ...
                                print(x + 1, " | ", digits,
                                      " Two Numbers Found with: +, and, includes, including. Might be range. Averaging and appending")
                                average = int(digits[0]) + int(digits[1])
                                totalAppends += 1
                                totalCorrections += 1
                                newComment = "<FLAG>No. Cats: " + digits[0] + " + " + digits[1] + "   "  + "  " + activeSheet.cell(x, 23).value
