				...
				<table>
					<thead>
						<tr>
							...
							<th colspan='2'><a href='volunteerlist.php?sort=Email'>Email</a></th>
					...
					{
						list($RecordNumber, $DateAndTime, $FullName, $CompleteAddress, $Email, $Phone1, $Phone2, $PreferedContact) = $row; // variables are set to current row
